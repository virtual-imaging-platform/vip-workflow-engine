...
import fr.insalyon.creatis.moteurlite.Iteration.CrossIteration;
import fr.insalyon.creatis.moteurlite.Iteration.DotIteration;
...
public class IterationStrategy {
    ...
    public void IterationStratergy(List<Map<String, String>> inputsMap, Map<String, String> resultDir, Set<String> crossJson, Set<String> dotJson) {
        crossCombinations = setCrossIteration(inputsMap, resultDir);
        dotCombinations = setDotIteration(inputsMap, resultDir);
        jsonCombinations = setJsonIteration(inputsMap, resultDir, crossJson, dotJson);
    }
    ...
    private List<Map<String, String>> setJsonIteration(List<Map<String, String>> inputsMap, Map<String, String> resultDir, Set<String> crossJson, Set<String> dotJson) {
        Map<String, List<String>> valuesMap = new HashMap<>();
        for (Map<String, String> map : inputsMap) {
            for (Map.Entry<String, String> entry : map.entrySet()) {
                String key = entry.getKey();
        ...
        List<Map<String, String>> jsonCombinations = JsonIteration.jsonIteration(valuesMap, crossJson, dotJson);
