...
import fr.insalyon.creatis.moteurlite.XMLParser.InputDownloads;
import fr.insalyon.creatis.moteurlite.XMLParser.InputParser;
...
public class ParseXMLFile {
    ...
    public void parseXMLFile(String inputsFilePath) {
    ...
    public static List<URI> getDownloadFiles(Map<String, String> inputsMap) {
        System.out.println("Download File URIs:");
